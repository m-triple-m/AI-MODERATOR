            ...
            <div className="card shadow-4-strong rounded-left">
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="py-4  mx-md-4 " style={{ color: '#fff', marginTop: '25%' }}>
                ...
                <div className="col-lg-6 mt-1 ">
                  <div className="card-body mx-md-4 my-5">
                    <img src="/AI.gif" alt="error" style={{ height: '100px', display: 'block', margin: 'auto' }} />

                    <div className="text-center mb-5 font-weight-bold my-5">
                      <h4 className="text-capitalize mb-0">Sign in to Account</h4>
                      <hr
                        className="hr mt-1"
                        style={{
