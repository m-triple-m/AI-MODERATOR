...
const AdminProfile = () => {
    ...
    const userForm = useFormik({
        initialValues: currentAdmin ? currentAdmin : {
            name: '',
            email: '',
            // number: '',
            // address: '',
        ...
        onSubmit: async (values) => {
            console.log(values)
            const res = await fetch(`${process.env.REACT_APP_API_URL}/admin/update` + currentAdmin._id, {
                method: 'PUT',
    ...
    const fetchProfileData = async () =>  {
        const res = await fetch(`${process.env.REACT_APP_API_URL}/admin/getbyid` + currentAdmin._id);
        console.log(res.status);
        if (res.status === 200) {
                            ...
                            <div className="card mb-4">
                                <div className="card-body text-center">
                                    <img
                                        ...
                                        style={{ width: 150 }}
                                    />
                                    <h5 className="my-3">{currentAdmin.name}</h5>
                                    <p className="text-muted mb-1">{currentAdmin.email}</p>
